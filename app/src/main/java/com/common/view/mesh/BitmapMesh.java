...
public class BitmapMesh {
    public static class SampleView extends View {
        ...
        public void setBitmap(Bitmap bitmap, int bitmap_Width, int bitmap_Height) {
...
//            mInhaleMesh.setBitmapSize(mBitmap.getWidth(), mBitmap.getHeight());
            mInhaleMesh.setBitmapSize(bitmap_Width, bitmap_Height);
            mInhaleMesh.setInhaleDir(InhaleMesh.InhaleDir.UP);
        }
        public void setBitmapWithXY(Bitmap bitmap,float x,float y) {
...
//            float h = mBitmap.getHeight();
            float w = bitmap_Width;
            float h = bitmap_Height;
            float endX = 0;
            float endY = 0;
            float dx = 10;
            float dy = 10;
        ...
        protected void onSizeChanged(int w, int h, int oldw, int oldh) {
            ...
            float bmpW = bitmap_Width;
            float bmpH = bitmap_Height;
