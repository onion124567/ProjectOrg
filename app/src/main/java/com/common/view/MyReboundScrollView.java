...
public class MyReboundScrollView extends ScrollView {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                onTranSlate.actionUp(originalRect.top - contentView.getTop());
    ...
    public void setOnTranSlate(OnTranSlate onTranSlate) {
    this.onTranSlate=onTranSlate;
    }

    OnTranSlate onTranSlate;

    public static interface OnTranSlate {
        public void moveOffset(int offset);

        public void actionUp(int offset);
    }
